    ...
    <footer className=" bg-amber-50 text-black">
      ...
      <div className="container bg-[#00492C] mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
          ...
          >
            <div className="mb-6">
              <h2 className="text-2xl font-bold text-primary mb-2">PUSHAAN</h2>
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-slate-300">hello@PUSHAAN.com</span>
              </div>
            </div>
          ...
          >
            ...
            <ul className="space-y-2">
              {footerLinks.shop.map((link, index) => (
                <li key={index}>
                  <a href="/shop" className="text-slate-300 hover:text-primary transition-colors text-sm">
                    {link}
                  </a>
                </li>
              ))}
