...
export function AboutContent() {
  ...
  const milestones = [
    { year: "2015", event: "PUSHAAN founded by Bala Sarda" },
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl md:text-2xl max-w-3xl mx-auto leading-relaxed">
              From a small dream in India to serving millions of tea lovers worldwide, discover the journey of PUSHAAN
              Teas.
            </p>
          </motion.div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                Bala Sarda, a 4th generation tea entrepreneur, founded PUSHAAN in 2015 with a revolutionary vision: to
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Key milestones that shaped PUSHAAN into the global tea brand it is today.
            </p>
          </motion.div>
