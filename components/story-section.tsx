        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto mb-16">
          ...
          >
            ...
            <div className="space-y-4 text-muted-foreground leading-relaxed">
              <p>
                Founded in 2015 by Bala Sarda, PUSHAAN Teas was born from a simple yet powerful vision: to make the
          ...
          >
            <div className="relative rounded-lg overflow-hidden">
              <img
                ...
                alt="Bala Sarda, Founder of PUSHAAN Teas in tea garden"
                className="w-full h-[500px] object-cover"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent" />
              <div className="absolute bottom-6 left-6 text-white">
                <h3 className="text-xl font-semibold mb-1">Bala Sarda</h3>
                <p className="text-sm opacity-90">Founder & CEO, PUSHAAN Teas</p>
              </div>
            </div>
          </motion.div>
        </div>
