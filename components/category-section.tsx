    ...
    <section className="bg-gradient-to-b from-white to-amber-50/30">
                ...
                <Link href="/shop">
                  ...
                  >
                    <div className="text-center">
                      <div className="relative w-full aspect-[3/4] max-w-[280px] mx-auto mb-8 overflow-hidden bg-[#00492C] shadow-2xl rounded-t-full">
                        <img
      ...
      <div className="py-20 container mx-auto px-4 sm:px-6 lg:px-8 space-y-24">
        {infoSections.map((section, index) => (
          <motion.div
            key={section.id}
            className={`flex flex-col md:flex-row items-center gap-8 md:gap-12 ${section.reverse ? "md:flex-row-reverse" : ""
              }`}
